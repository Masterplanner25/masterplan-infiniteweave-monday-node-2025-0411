...
to produce a flow dict compatible with :class:`~services.flow_engine.PersistentFlowRunner`
and ``FLOW_REGISTRY``.
...
class NodusFlowGraph:
    ...
    by :class:`~services.flow_engine.PersistentFlowRunner`.
    ...
    def compile(self) -> dict:
        """
        Build a :class:`~services.flow_engine.PersistentFlowRunner`-compatible
...
def compile_nodus_flow(script: str, flow_name: str) -> dict:
    ...
    dict
        ...
        :class:`~services.flow_engine.PersistentFlowRunner`.
