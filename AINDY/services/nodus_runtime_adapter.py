...
class NodusRuntimeAdapter:
    ...
    def run_script(
        ...
        return self._execute(script, filename, context)
    ...
    def run_file(
        ...
        return self._execute(script, path, context)
    ...
    def _execute(
        ...
        try:
            ...
            from services.nodus_builtins import NodusMemoryBuiltins, NodusEventBuiltins, NodusWaitSignal
            ...
            try:
                from services.nodus_builtins import NodusWaitSignal as _WaitSig
...
#   import services.nodus_adapter  # ensure nodes are registered
#
