...
from services.syscall_registry import SyscallContext, SYSCALL_REGISTRY
...
class TestTaskHandlers:
    def test_task_create_returns_task_fields(self):
        from services.syscall_handlers import _handle_task_create
    ...
    def test_task_complete_returns_task_result(self):
        from services.syscall_handlers import _handle_task_complete
    ...
    def test_task_complete_full_returns_service_result(self):
        from services.syscall_handlers import _handle_task_complete_full
    ...
    def test_task_start_returns_message(self):
        from services.syscall_handlers import _handle_task_start
    ...
    def test_task_pause_returns_message(self):
        from services.syscall_handlers import _handle_task_pause
...
class TestLeadgenHandlers:
    def test_leadgen_search_returns_serialized_results(self):
        from services.syscall_handlers import _handle_leadgen_search
    ...
    def test_leadgen_search_ai_returns_leads(self):
        from services.syscall_handlers import _handle_leadgen_search_ai
    ...
    def test_leadgen_store_skips_memory_on_no_user(self):
        from services.syscall_handlers import _handle_leadgen_store
...
class TestArmHandlers:
    def test_arm_analyze_returns_analysis_fields(self):
        from services.syscall_handlers import _handle_arm_analyze
    ...
    def test_arm_generate_returns_generated_code(self):
        from services.syscall_handlers import _handle_arm_generate
    ...
    def test_arm_store_returns_stored_true(self):
        from services.syscall_handlers import _handle_arm_store
...
class TestGenesisHandlers:
    def test_genesis_execute_llm_returns_reply(self):
        from services.syscall_handlers import _handle_genesis_execute_llm
    ...
    def test_genesis_message_calls_execute_intent(self):
        from services.syscall_handlers import _handle_genesis_message
...
class TestScoreHandlers:
    def test_score_recalculate_returns_score_data(self):
        from services.syscall_handlers import _handle_score_recalculate
    ...
    def test_score_feedback_persists_and_returns_id(self):
        from services.syscall_handlers import _handle_score_feedback
...
class TestWatcherHandlers:
    ...
    def test_watcher_ingest_raises_on_empty_signals(self):
        from services.syscall_handlers import _handle_watcher_ingest
...
class TestGoalHandlers:
    def test_goal_create_raises_on_missing_name(self):
        from services.syscall_handlers import _handle_goal_create
...
class TestResearchAndAgentHandlers:
    def test_research_query_raises_on_empty_query(self):
        from services.syscall_handlers import _handle_research_query
        with pytest.raises(ValueError, match="requires 'query'"):
    ...
    def test_agent_suggest_tools_returns_empty_on_no_kpi(self):
        from services.syscall_handlers import _handle_agent_suggest_tools
