...
class TestEventTriggers:
    ...
    def test_daily_score_job_registered(self):
        ...
        assert "daily_infinity_score_recalculation" in src, \
            "daily_infinity_score_recalculation not wired in _register_system_jobs"
        assert "_recalculate_all_scores" in src, \
...
class TestSocialFeedRanking:
    ...
    def test_infinity_ranked_score_function_exists(self):
        ...
        import sys
        mod = sys.modules.get("routes.social_router")
        assert mod is not None, "routes.social_router module not loaded"
