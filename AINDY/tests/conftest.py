...
_SERVICE_COMPAT_SOURCES = {
    "genesis_ai.py": Path(ROOT) / "domain" / "genesis_ai.py",
    "masterplan_factory.py": Path(ROOT) / "domain" / "masterplan_factory.py",
    "scheduler_service.py": Path(ROOT) / "platform_layer" / "scheduler_service.py",
    "task_services.py": Path(ROOT) / "domain" / "task_services.py",
    "nodus_adapter.py": Path(ROOT) / "runtime" / "nodus_adapter.py",
    "agent_runtime.py": Path(ROOT) / "agents" / "agent_runtime.py",
}
