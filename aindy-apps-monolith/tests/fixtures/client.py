...
from tests.helpers.runtime import clear_boot_profile_env
...
def _fresh_main_app(*, runtime_only: bool, require_apps: bool):
    if runtime_only or not require_apps:
        raise RuntimeError("The extracted apps test client only supports app-profile boot.")
