...
# -------------------------
# Import the project's Base and register all models so Alembic can
# autogenerate migrations.
# - ``AINDY.db.model_registry`` loads runtime-owned platform models.
# - ``apps.bootstrap.bootstrap_models()`` loads app-owned models into the same
#   shared metadata for the current monolith deployment shape.
# - Avoid importing main.py by default: uncomment only if main.py is safe (no
#   server startup).
#
