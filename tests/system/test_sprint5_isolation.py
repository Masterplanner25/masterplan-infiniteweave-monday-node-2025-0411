...
class TestFreelanceIsolation:
    ...
    def test_freelance_router_has_user_id_assignment(self):
        ...
        source = _read_source(str(_APPS_DIR / "freelance" / "routes" / "freelance_router.py"))
    ...
    def test_freelance_service_passes_user_id(self):
        ...
        from apps.freelance.services.freelance_service import create_order, collect_feedback, get_all_orders, get_all_feedback
        import inspect
...
class TestResearchIsolation:
    ...
    def test_research_router_has_user_id_assignment(self):
        ...
        source = _read_source(str(_APPS_DIR / "search" / "routes" / "research_results_router.py"))
    ...
    def test_research_service_passes_user_id(self):
        ...
        from apps.search.services.research_results_service import (
...
class TestRippletraceIsolation:
    ...
    def test_rippletrace_router_has_user_id_assignment(self):
        ...
        source = _read_source(os.path.join(_APPS_DIR, 'rippletrace', 'routes', 'rippletrace_router.py'))
...
class TestUserIdColumnPresence:
    ...
    def test_client_feedback_model_has_user_id(self):
        from apps.freelance.models.freelance import ClientFeedback
