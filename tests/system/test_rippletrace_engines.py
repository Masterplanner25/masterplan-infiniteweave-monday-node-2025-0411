...
from apps.rippletrace.services import content_generator, strategy_engine
...
def test_endpoints_return_success(client, monkeypatch, endpoint, patches, api_key_headers):
    legacy_surface_module = importlib.import_module("apps.rippletrace.routes.legacy_surface_router")
