...
class TestSchedulerService:
    ...
    def test_replay_task_returns_false_for_missing_log(self):
        ...
        # replay_task resolves SessionLocal through AINDY.db.database locally
...
class TestAutomationEndpoints:
    ...
    def test_replay_rejects_invalid_execution_token(self, test_user):
        ...
        from apps.automation.routes.automation_router import router
...
class TestTaskServicesNoDaemonThreads:
    ...
    def test_stop_background_tasks_importable(self):
        from apps.tasks.services.task_service import stop_background_tasks
