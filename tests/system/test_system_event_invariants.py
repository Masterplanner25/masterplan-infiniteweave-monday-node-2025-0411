...
def _reset_trace_context():
    from AINDY.platform_layer.trace_context import _trace_id_ctx
...
def test_loop_execution_emits_started_and_decision_events(monkeypatch):
    ...
    monkeypatch.setattr("apps.analytics.services.infinity_orchestrator.emit_system_event", _capture)
    monkeypatch.setattr(
