...
_MASTERPLAN_ROUTES_DIR = _APPS_DIR / "masterplan" / "routes"
...
class TestSprint6SQLAlchemy:
    ...
    def test_sqlalchemy_base_importable(self):
        """Base should be importable from AINDY.db.database."""
    ...
    def test_new_import_path_in_source(self):
        ...
        import AINDY.db.database as db_module
...
class TestSprint7GenesisMemoryHook:
    ...
    def test_genesis_router_passes_user_id_to_llm(self):
        ...
        source = _read_source(os.path.join(_MASTERPLAN_ROUTES_DIR, "genesis_router.py"))
...
class TestSprint7LeadGenMemoryHook:
    ...
    def test_leadgen_router_passes_user_id(self):
        ...
        source = _read_source(str(_APPS_DIR / "search" / "routes" / "leadgen_router.py"))
