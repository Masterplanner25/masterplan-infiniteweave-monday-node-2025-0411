...
class TestCalculationResultModel:
    ...
    def test_calculation_result_wrong_table_bug_documented(self):
        ...
        ADDITIONAL BUG: bridge.py used the legacy root db compatibility package
        to import CalculationResult, but db/models/models.py does NOT EXIST.
        The correct path is apps.analytics.models.
