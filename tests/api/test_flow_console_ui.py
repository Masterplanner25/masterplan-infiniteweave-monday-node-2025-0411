...
class TestFlowRunsEndpoints:
    ...
    def test_get_run_rejects_cross_user_flow_run(self, client, db_session):
        owner_id = uuid.UUID("00000000-0000-0000-0000-000000000011")
        caller_id = uuid.UUID("00000000-0000-0000-0000-000000000012")
        db_session.add_all(
            [
                User(
                    id=owner_id,
                    email="flow-owner@aindy.test",
                    username="flow_owner",
