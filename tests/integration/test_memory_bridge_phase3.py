...
class TestARMAnalysisMemoryHook:
    ...
    def _make_analyzer(self):
        ...
        with patch("apps.arm.services.deepseek.deepseek_code_analyzer.OpenAI"):
    ...
    def test_analysis_writes_outcome_node_on_success(self):
        ...
        with patch("apps.arm.services.deepseek.deepseek_code_analyzer.queue_memory_capture") as mock_qmc:
    ...
    def test_analysis_recall_runs_before_prompt(self):
        ...
        with patch(_ORCH_PATH + ".get_context") as mock_get_context:
            ...
            with patch("apps.arm.services.deepseek.deepseek_code_analyzer.queue_memory_capture"):
...
class TestGenesisMemoryHooks:
    ...
    def _make_app(self, mock_db, mock_user):
        ...
        from apps.masterplan.routes.genesis_router import router
    ...
    def test_lock_writes_decision_node(self):
        ...
        with patch("apps.masterplan.routes.genesis_router._get_user_session"), \
             patch("apps.masterplan.routes.genesis_router.create_masterplan_from_genesis", return_value=mock_masterplan), \
