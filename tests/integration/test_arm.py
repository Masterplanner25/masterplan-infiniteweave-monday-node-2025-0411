...
class TestARMRoutes:
    ...
    def test_analyze_with_auth_and_mocked_openai(
        ...
        mocker.patch(
            "apps.arm.services.deepseek.deepseek_code_analyzer.OpenAI",
        ...
        import apps.arm.routes.arm_router as arm_mod
...
class TestARMConfigSuggestions:
    ...
    def test_no_suggestions_when_metrics_healthy(self):
        ...
        from apps.arm.services.arm_metrics_service import ARMConfigSuggestionEngine
