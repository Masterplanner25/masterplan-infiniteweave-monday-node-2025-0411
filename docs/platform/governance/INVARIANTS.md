...
- `alembic/versions/bff24d352475_create_memory_nodes_links.py`
- `alembic/versions/831b86c9e536_improve_memory_nodes_indexes.py`
- `alembic/versions/a318e9194478_improve_memory_nodes_uuid_defaults_tsv_.py`
- `alembic/versions/f4ef29bb03f3_merge_task_models.py`
...
- Enforcement Location:
- `alembic/versions/c7602451aabb_init_memory_persistence.py`
- `alembic/versions/f4ef29bb03f3_merge_task_models.py`
...
- `alembic/versions/97ef6237e153_structure_integrity_check.py`
...
- `AINDY/apps/freelance/models/freelance.py`: `client_name`, `client_email`, `service_type`, `price` are `nullable=False`.
- `AINDY/services/memory_persistence.py` and `alembic/versions/c7602451aabb_init_memory_persistence.py`: `memory_nodes.content`, `memory_nodes.node_type`, `memory_links.source_node_id`, `memory_links.target_node_id`, `memory_links.link_type`, `memory_links.strength` are `nullable=False`.
...
- `alembic/versions/a318e9194478_improve_memory_nodes_uuid_defaults_tsv_.py`
- `alembic/versions/831b86c9e536_improve_memory_nodes_indexes.py`
- `alembic/versions/f4ef29bb03f3_merge_task_models.py` (drops content_tsv/index)
